...
<p align="justify">Once the image is built and containers are running mongodb can be accessed on the port 27017 of the localhost and the application Node-Red on the port 1880 (HTTP) </p>
